import { fetchAllUsers, fetchUserById, editUserById, removeUserById } from '#controllers/users.controller';
...
router.delete('/:id', authenticateToken, requiredRole(['admin']), removeUserById);
